...
class AgentOrchestrator:
    ...
    def build_graph(self) -> StateGraph:
        ...
        async def system_agent_node(state: NodusState) -> dict:
            ...
            system_prompt = SystemMessage(content="You are Nodus, a private cognitive AI. Be concise and helpful.")
    ...
    async def process_stream(self, message: str) -> AsyncGenerator[str, None]:
        ...
        initial_state = {"messages": [HumanMessage(content=message)], "current_agent": "SystemAgent"}
        ...
        async for event in self.graph.astream_events(initial_state, version="v2"):
            ...
            if kind == "on_chat_model_stream":
                ...
                if event["name"] == "system_agent":
                    yield json.dumps({"type": "agent_state", "current_agent": "SystemAgent", "status": "Completed"})
